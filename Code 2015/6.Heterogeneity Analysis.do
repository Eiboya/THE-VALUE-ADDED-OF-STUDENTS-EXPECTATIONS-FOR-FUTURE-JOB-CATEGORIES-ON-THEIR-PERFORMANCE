...
** OLS with covariates
forvalues i=1(1)10 {
  ivreg2 PV`i'SCIE (HavePlan=guide2) $x c.HavePlan#c.HKG c.HavePlan#c.DEU [pw=W_FSTUWT] , cluster(CNTSCHID)
  gen treatment`i'=_b[HavePlan]
  gen SDtreatment`i'=_se[HavePlan]
  gen Treat_HKG`i'=_b[c.HavePlan#c.HKG]
  gen SDTreat_HKG`i'=_se[c.HavePlan#c.HKG]
...
***FE with interactions
forvalues i=1(1)10 {
  ivreghdfe PV`i'SCIE (HavePlan=guide2) $x c.HavePlan#c.HKG c.HavePlan#c.DEU [pw=W_FSTUWT] , cluster(CNTSCHID) absorb(CNTRYID)
  gen treatment`i'=_b[HavePlan]
  gen SDtreatment`i'=_se[HavePlan]
  gen Treat_HKG`i'=_b[c.HavePlan#c.HKG]
  gen SDTreat_HKG`i'=_se[c.HavePlan#c.HKG]
...
** OLS with covariates
forvalues i=1(1)10 {
  ivreg2 PV`i'SCIE (High=guide2) $x c.High#c.HKG c.High#c.DEU [pw=W_FSTUWT] , cluster(CNTSCHID)
  gen treatment`i'=_b[High]
  gen SDtreatment`i'=_se[High]
  gen Treat_HKG`i'=_b[c.High#c.HKG]
  gen SDTreat_HKG`i'=_se[c.High#c.HKG]
...
***FE with interactions
forvalues i=1(1)10 {
  ivreghdfe PV`i'SCIE (High=guide2) $x c.High#c.HKG c.High#c.DEU [pw=W_FSTUWT] , cluster(CNTSCHID) absorb(CNTRYID)
  gen treatment`i'=_b[High]
  gen SDtreatment`i'=_se[High]
  gen Treat_HKG`i'=_b[c.High#c.HKG]
  gen SDTreat_HKG`i'=_se[c.High#c.HKG]
